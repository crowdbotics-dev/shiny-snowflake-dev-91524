...
## Project Structure
    ...
    ├── shiny_snowflake_dev_91524  # Django project configurations
...
1. Clone this repo and `cd shiny_snowflake_dev_91524`
...
2. Clone this repo and `cd shiny_snowflake_dev_91524`
